...
SLOT="0"
LICENSE="MIT"
IUSE="badfiles bpd bs1770gain chroma convert doc discogs flac gstreamer lastgenre lastimport mpdstats ogg opus replaygain test thumbnails web"

RDEPEND="python_targets_python2_7? ( >=dev-python/enum34-1.0.4[${PYTHON_USEDEP}] )
